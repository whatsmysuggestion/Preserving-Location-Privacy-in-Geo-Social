      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle><b>Request for get Index!</b></marquee>
								</b></font></h1>
									...
									%>
									<form action="getindex1.jsp" method="get">
                                 <table>
								 <tr><td><font size="3"><b>Id</b></font></td>
								 <td><input type="text" name="id" class="c" value="<%=a%>"></td>
								 </tr>
								 <tr><td><font size="3"><b>Name</b></font></td>
								 <td><input type="text" name="id" class="c" value="<%=name%>"></td>
								 </tr>
								 
								 
								 <tr><td><font size="3" ><b>Enter Ur Secret for getting Index</b></font></td>
