...
<body>
      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
				...
				<tr>
				 ...
				 <td width="65" bgcolor="#FF9900"><font color="#FFFFFF" size="+1">User Id</font></td>
            <td width="50" bgcolor="#FF9900"><p><font color="#FFFFFF" size="+1">User </font></p>
                    <p><font color="#FFFFFF" size="+1">Name</font></p></td>
			  <td width="41" bgcolor="#FF9900"><font color="#FFFFFF" size="+1">Email</font></td>
			 <td width="31" bgcolor="#FF9900"><font color="#FFFFFF" size="+1">Location Name</font></td>
	
			 
           <td width="31" bgcolor="#FF9900"><font color="#FFFFFF" size="+1">Lattitude</font></td>
	 <td width="31" bgcolor="#FF9900"><font color="#FFFFFF" size="+1">Langitude</font></td>
	

			
			 <td width="135" bgcolor="#FF9900"><font color="#FFFFFF" size="+1">Send to requested user</font></td>
...
PreparedStatement ps=con.prepareStatement("select  id,uname,email,location,lattitude,langitude from index_server where status='"+x+"'");
...
s4=rs.getString(5);
session.setAttribute("latt",s4);
System.out.println(s4);
s5=rs.getString(6);
session.setAttribute("langi",s5);
 ...
 %>
		  ...
		  <td bgcolor="#000000"> 
      	  ...
      	  <td bgcolor="#000000"> 
			 ...
			 <td bgcolor="#000000"> 
               <font color="#0000000"><%=s5%></font>
            </td>
			
            
				  <td bgcolor="#000000">  <a href="uupdate1.jsp?as=<%=id%>"><font color="#0000000">send to user</font></a></td>
          </tr>
				 <%
