					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle>Send Secret to friends Page!</marquee>
									...
									<form action="secret1.jsp" method="get">
									<table width="243" height="109" align="center">
									
									<tr><td><font size="3" color="#FFCC00"><b>My Id</b></font>
									 </td><td><input type="text" name="mid" class="a"></td></tr>
									<tr><td><font size="3" color="#FFCC00"><b>Friend Id</b></font>
									 </td>
									 <td><input type="text" name="id" class="a"></td></tr>
									 <tr><td><font size="3" color="#FFCC00"><b>Email</b></font></td>
									 <td><input type="text" name="email" class="a"></td>
									 </tr>
									 <tr><td><font size="3" color="#FFCC00"><b>Message</b></font></td>
									 <td><input type="text" name="msg" class="a"></td>
									 </tr>
