					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle>Send Secret to friends Page!</marquee>
									...
									<table align="center" width="551" height="152">
				
				<tr>
				
				 <td width="83"   bgcolor="#996600"><font color="#FFFFFF" size="+1">User Id</font></td>
            <td width="128" bgcolor="#996600"><p><font color="#FFFFFF" size="+1">User 
                Name</font></p>
                    </td>
			  <td width="56" bgcolor="#996600"><font color="#FFFFFF" size="+1">Email</font></td>
			
			 
          

			
			 <td width="264" bgcolor="#996600"><font color="#FFFFFF" size="+1">request send to index</font></td>
...
PreparedStatement ps=con.prepareStatement("select  id,uname,email,location,lattitude,langitude,date from proxy where status='"+x+"'");
ResultSet rs=ps.executeQuery();
	
while(rs.next())
 {
 id=rs.getInt(1);
 session.setAttribute("ido",id);
             ...
             <font color="#0000000"><%=id%></font>
              ...
              <font color="#0000000"><%=s1%></font>
               ...
               <font color="#0000000"><%=s2%></font>
				  ...
				  <td bgcolor="#000000">  <a href="request_send.jsp?as=<%=id%>"><font color="#0000000">send to server</font></a></td>
          </tr>
				 <%
...
%>
	  ...
	  <p><img src="favicon.png"><a  href="index.html">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3" color="#000000"><b> 
        Home</b></font></a></p>
      <p> <img src="favicon.png"><a  href="proxxyy.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3" color="#000000"><b> 
        Back</b></font></a> </p>
    </div>
						</div>
