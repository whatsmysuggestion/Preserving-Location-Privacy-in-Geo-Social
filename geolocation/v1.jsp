...
<body>
      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle><b>Send to Proxy!</b></marquee>
								</b></font></h1>
                                    
									<form action="v2.jsp" method="get">
									<table width="243" height="109" align="center"><tr><td><font size="3" color="#FFCC00"><b>Friend Id</b></font>
									 </td>
									 <td><input type="text" name="id" class="a"></td></tr>
									
									 <tr><td><font size="3" color="#FFCC00"><b>Locatin</b></font></td>
									 <td><input type="text" name="location" class="a"></td>
									 </tr>
	  ...
	  <p><img src="favicon.png"><a  href="index.html">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3" color="#000000"><b> 
        Home</b></font></a></p>
      <p> <img src="favicon.png"><a  href="verifykey.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3" color="#000000"><b> 
        Back</b></font></a> </p>
    </div>
						</div>
