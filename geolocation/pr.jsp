      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle>Enter Your Friend Id!!!!!!</marquee>
								</b></font></h1>
                                    
									<form action="pr1.jsp" method="get">
									<table width="243" height="109" align="center">
									<tr><td></td><td><table>
									
									
									 <tr><td><font size="3" color="#FFCC00"><b>Enter ur Secret place</b></font></td>
