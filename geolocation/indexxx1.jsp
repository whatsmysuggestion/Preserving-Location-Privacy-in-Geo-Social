      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
            ...
            <td width="50" bgcolor="#CC0099"><p><font color="#FFFFFF" size="+1">User </font></p>
			 ...
			 <td width="31" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Location Name</font></td>
			  ...
			  <td width="31" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Data Name</font></td>
	
          
 <td width="31" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Date</font></td>
...
PreparedStatement ps=con.prepareStatement("select  uid,uname,uemail,location_name,dname,date from server ");
