...
<body>
      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
					...
					session.setAttribute("location",a);
					String b=request.getParameter("dname");
					session.setAttribute("dname",b);
					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle><b>Send Data to data server!!!!!!</b></marquee>
								</b></font></h1>
                                    
									<form action="data_send2.jsp" ENCTYPE="multipart/form-data" method="post">
									<table width="588" height="223" align="center">
									<tr><td width="251"><img src="images/file1.png"></td><td width="290"><table width="349" height="131">
									
									<tr><td width="97"><font size="3" color="#FFCC00"><b>Name</b></font>
									 </td>
									 <td width="219"><input type="text"  value="<%=a%>"class="a"></td></tr>
									 <tr><td><font size="3" color="#FFCC00"><b>Data Name</b></font></td>
									 <td><input type="text"  value="<%=b%>" class="a"></td>
									 </tr>
									  <tr><td><font size="3" color="#FFCC00"><b>Data Name</b></font></td>
	  ...
	  <p><img src="favicon.png"><a  href="index.html">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3" color="#000000"><b> 
        Home</b></font></a></p>
      <p> <img src="favicon.png"><a  href="data_send.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3" color="#000000"><b> 
        Back</b></font></a> </p>
    </div>
						</div>
