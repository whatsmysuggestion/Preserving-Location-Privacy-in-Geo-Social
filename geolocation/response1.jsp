...
<body>
      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
				...
				<tr>
				 ...
				 <td width="65"  bgcolor="#CC0099"><font color="#FFFFFF" size="+1">User Id</font></td>
            <td width="50" bgcolor="#CC0099"><p><font color="#FFFFFF" size="+1">User </font></p>
                    <p><font color="#FFFFFF" size="+1">Name</font></p></td>
			  <td width="41" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Email</font></td>
			 <td width="31" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Location Name</font></td>
	
			 
           <td width="31" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Lattitude</font></td>
	 <td width="31" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Langitude</font></td>
	
<td width="31" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">View MAp</font></td>
...
String fid=(String)session.getAttribute("ffid");
int id=0;
String id1=null,id2=null;
try
{
Connection con = databasecon.getconnection();
PreparedStatement ps=con.prepareStatement("select  id,uname,email,location,lattitude,langitude from proxy where id='"+fid+"'");
...
System.out.println(s5);
 ...
 %>
		  ...
		  <td bgcolor="#000000"> 
			...
			<td bgcolor="#000000"> 
              <a href="map.jsp"> <font color="#0000000">Map</font></a>
            </td>
