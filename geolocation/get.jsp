...
<body>
      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applicatio 
        ns</b></font> </p>
    </div>
					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle>Send Secret to friends Page!</marquee>
									...
									<table align="center" width="345" height="108">
				
				<tr>
				
				 <td width="71"  bgcolor="#CC0099"><font color="#FFFFFF" size="+1">User Id</font></td>
            <td width="47" bgcolor="#CC0099"><p><font color="#FFFFFF" size="+1">User </font></p>
                    <p><font color="#FFFFFF" size="+1">Name</font></p></td>
			  <td width="41" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Email</font></td>
			 <td width="68" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Location Name</font></td>
	
			 
          

			
			 <td width="103" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Send to index Server</font></td>
