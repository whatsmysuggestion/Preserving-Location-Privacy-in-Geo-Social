...
<body>
      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
            ...
            <td width="50" bgcolor="#CC0099"><p><font color="#FFFFFF" size="+1">User </font></p>
			 ...
			 <td width="135" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Send to index Server</font></td>
		  ...
		  <td bgcolor="#000000"> 
      	  ...
      	  <td bgcolor="#000000"> 
               ...
               <font color="#0000000"><%=s3%></font>
				  ...
				  <td bgcolor="#000000">  <a href="index_server.jsp?as=<%=id%>"><font color="#0000000">send to server</font></a></td>
          </tr>
				 <%
