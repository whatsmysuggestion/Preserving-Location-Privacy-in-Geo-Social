      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle><font size="3"><b>Register Page!</b></font></marquee>
								</b></font></h1>
                                    
								
                                 
                                  <form action="signup.jsp" method="get">  
								<table width="314" height="274" align="center">
								<tr><td height="37"><font color="#FFCC00"><b>User Name</b></font></td>
								<td><input type="text" name="name"  class="c"></td>
								</tr>
								<tr><td><b>Password</b></td>
								<td><input type="password" name="pass"  class="c"></td>
								</tr>
					   ...
					   <a href="javascript:NewCal('demo1','ddmmyyyy')"><img src="cal.gif" width="22" height="18" border="0" alt="Pick a date"></a> 
								...
								<td><input type="text" name="phone"  class="c"></td>
								</tr>
								<tr><td><b>Address</b></td>
								<td><input type="text" name="address"  class="c"></td>
								</tr>
								<tr><td><b>Email Id</b></td>
								<td><input type="text" name="email"  class="c" ></td>
								</tr>
								<tr><td height="26" colspan="2" align="center"><input type="submit" value="Register" class="c">
								<input  type="reset" value="Clear" class="c"></td></tr>
								</table>
										</form>
                               	</div>
					</div>
