      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle><b>Request for getting data</b></marquee>
								</b></font></h1>
                                    
									<%
									
									Integer a=(Integer)session.getAttribute("id");
									session.setAttribute("oo",a);
									String name=(String)session.getAttribute("nname");
									%>
									<form action="sendrequest1.jsp" method="get">
                                 <table align="center">
								 <tr><td><font size="3"><b> Your Friend Id</b></font></td>
								 <td><input type="text" name="id" class="c" value="<%=a%>"></td>
								 </tr>
								 <tr><td><font size="3"><b>Your Name</b></font></td>
								 <td><input type="text" name="id" class="c" value="<%=name%>"></td>
								 </tr>
								 
								 
								 <tr><td><font size="3" ><b>Enter the data Name</b></font></td>
								 <td><input type="text" name="key" class="c"></td></tr>
								 <tr><td colspan="2" align="center"><input  class="a" type="submit" name="Submit"
								  value="Submit"></td></tr>
