...
<body>
      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle><b>Key Verify Page!!!!!</b></marquee>
								</b></font></h1>
								<form action="v.jsp" method="get">
                                 <table><tr>
								 <td><img src="images/keysuccess2.png"></td>
								 
								 <td>
								 <font size="+2" color="#CCCC00"><b>Your key is verified.waiting
								  for getting index location</b></font></td></tr>
								  <tr><td colspan="2" align="center"><input type="submit" value="ENTER" class="c"></td></tr>
								  </table>   
	  ...
	  <p><img src="favicon.png"><a  href="index.html">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3" color="#000000"><b> 
        Home</b></font></a></p>
      <p> <img src="favicon.png"><a  href="getindex.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3" color="#000000"><b> 
        Back</b></font></a> </p>
    </div>
						</div>
