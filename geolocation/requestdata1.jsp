      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
					...
					<div class="grid_18 alpha" id="mid_container_wap">
						<div class="grid_18 alpha mid_container" id="about">
								...
								<marquee hspace=20 vspace=20 width=250  align=middle><b>Get the response from data server</b></marquee>
								</b></font></h1>
				...
				<tr>
				 ...
				 <td width="65" bgcolor="#999900"><font color="#FFFFFF" size="+1">Friend Id</font></td>
            <td width="50" bgcolor="#999900"><p><font color="#FFFFFF" size="+1">Friend </font></p>
                    <p><font color="#FFFFFF" size="+1">Name</font></p></td>
			  <td width="41" bgcolor="#999900"><font color="#FFFFFF" size="+1">Email</font></td>
			 <td width="31" bgcolor="#999900"><font color="#FFFFFF" size="+1">Location Name</font></td>
	
			 
           <td width="31" bgcolor="#999900"><font color="#FFFFFF" size="+1">Data Name</font></td>
	 <td width="31" bgcolor="#999900"><font color="#FFFFFF" size="+1">Status</font></td>
	
 <td width="31" bgcolor="#999900"><font color="#FFFFFF" size="+1">Decrypt</font></td>
...
PreparedStatement ps=con.prepareStatement("select  uid,uname,uemail,location_name,dname,file from server where request='"+x+"'");
 ...
 %>
		  ...
		  <td bgcolor="#000000"> 
      	  ...
      	  <td bgcolor="#000000"> 
			  ...
			  <td bgcolor="#000000">  <a href="download1.jsp?as=<%=s%>"><font color="#0000000">download</font></a></td>
        
			<td bgcolor="#000000">  <a href="pr.jsp?as=<%=s%>"><font color="#0000000">download</font></a></td>
