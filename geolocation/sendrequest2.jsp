...
<body>
      ...
      <p><font size="5" ><b>Preserving Location Privacy in Geo-Social Applications</b></font> 
            ...
            <td width="50" bgcolor="#CC0099"><p><font color="#FFFFFF" size="+1">User </font></p>
			 ...
			 <td width="41" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Location name</font></td>
			
			 

			
			 <td width="135" bgcolor="#CC0099"><font color="#FFFFFF" size="+1">Status</font></td>
...
PreparedStatement ps=con.prepareStatement("select uid,uname,uemail,location_name,request from server ");
...
%>
	  ...
	  <p><img src="favicon.png"><a  href="index.html">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3" color="#000000"><b> 
        Home</b></font></a></p>
      <p> <img src="favicon.png"><a  href="sendrequest2.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="3" color="#000000"><b> 
        Back</b></font></a> </p>
    </div>
						</div>
